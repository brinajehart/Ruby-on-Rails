...
ActiveRecord::Schema.define(version: 2020_01_29_080102) do
  ...
  create_table "friends", force: :cascade do |t|
    ...
    t.index ["Users2_id"], name: "index_friends_on_Users2_id"
  end
  ...
  add_foreign_key "friends", "users", column: "Users2_id"
